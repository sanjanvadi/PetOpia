...
const router = Router();
import { createUser, createApp, createMed, getPet, createPet, createPres, deleteApp, deleteMed, deletePet, deletePres, getAllPets, updatePet } from "../data/pet.js";
import xss from 'xss';
...
router.route('/mypet/:userId/:petId')
.get(async (req, res) => {
    try {
